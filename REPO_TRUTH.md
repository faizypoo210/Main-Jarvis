...
| **Voice path** | STT/TTS and forwarding toward control plane / streams; **direct Ollama** acks do not populate mission `routing_decided` or executor `lane_truth` | `voice/` | Whisper/GPU env, local `.env` beside `server.py`; lane vocabulary: `docs/MODEL_LANES.md` |

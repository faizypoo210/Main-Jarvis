...
| **GitHub — governed create issue + draft PR** | **Implemented** (narrow) | `POST .../github/create-issue`, `POST .../github/create-pull-request`, `github_issue_workflow.py`, `github_pr_workflow.py`, `github_adapter.py` | Approval-gated (`github_create_issue` / `github_create_pull_request`, risk **red**); `JARVIS_GITHUB_TOKEN`; PR path creates **draft PR from existing branches only** | `docs/INTEGRATIONS_GITHUB.md` |

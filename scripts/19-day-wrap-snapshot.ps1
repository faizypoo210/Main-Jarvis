...
[void]$sb.AppendLine('')
[void]$sb.AppendLine('## Operational docs (next session)')
[void]$sb.AppendLine('')
[void]$sb.AppendLine('- **Bring-up / start order / smoke:** `docs/BRINGUP_RUNBOOK.md`')
[void]$sb.AppendLine('- **Env vars by service:** `docs/ENV_MATRIX.md`')
[void]$sb.AppendLine('- **Tomorrow resume pack:** `docs/TOMORROW_RESUME.md`')
[void]$sb.AppendLine('- **Architecture snapshot:** `docs/ARCHITECTURE_V3.md`')
[void]$sb.AppendLine('')
